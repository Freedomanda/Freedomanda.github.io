sap.ui.define([
	...
	return UIComponent.extend("sap.ui.demoapps.rta.freestyle.Component", {
		...
		_shouldUseFakeLrep : function(){
			//against old UI5 versions, URLParser is not there yet, 
			//to ease demos fallback to always mock in this case
			try{
				var UrlParser = sap.ui.requireSync(["sap/ui/rta/util/UrlParser"]);
