...
sap.ui.define(
	...
	function() {
		...
		// FIXME: uncomment after bug with 1870188915 is solved
		...
		// 	iWaitUntilTheCompactContextMenuAppears("sap-icon://edit", "Rename").
		// 	iClickOnAnElementOverlay("application-masterDetail-display-component---ProductDetail--GeneralForm--productLabel").
		...
		opaTest("Moving a Field via Cut and Paste to a GroupElement", function(Given, When, Then) {
			...
			// Assertions
			Then.onTheMasterPageWithRTA.theGroupElementHasTheCorrectIndex(sId2, sId, true);
		});
		...
		opaTest("Moving a Field via Cut and Paste to a Group", function(Given, When, Then) {
			...
			// Assertions
			Then.onTheMasterPageWithRTA.theGroupElementHasTheLastIndex(sId);
		});
		...
		opaTest("Reloading the App", function(Given, When, Then) {
			...
			When.onTheMasterPageWithRTA.iScrollDown("application-masterDetail-display-component---ProductDetail--ObjectSectionSupplier");

			Then.onTheMasterPageWithRTA.iShouldSeeChangesInLRepWhenTheBusyIndicatorIsGone("idAppControl", "Root", 6).
			// FIXME: uncomment after bug with 1870188915 is solved
