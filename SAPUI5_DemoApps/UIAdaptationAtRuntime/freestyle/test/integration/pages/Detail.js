		...
		onTheDetailPage: {
			...
			assertions: {
				...
				iShouldSeeTheRememberedObjectId: function() {
					return this.waitFor({
						success: function() {
							var sBindingPath = "/SEPMRA_C_PD_Product('" + this.getContext().currentId + "')";
							this._waitForPageBindingPath(sBindingPath);
						}
					});
				},
						...
						success: function(aEntitySet) {
							...
							return this.waitFor({
								...
								check: function(oList) {
									...
									var sObjectID = oList.getBindingContext().getProperty("ActiveProduct");

									var iLength = aEntitySet.filter(function(oLineItem) {
										return oLineItem.ActiveProduct === sObjectID;
									}).length;
				...
				theShareTileButtonShouldContainTheRememberedObjectName: function() {
					return this.waitFor({
						...
						matchers: function(oButton) {
							var sObjectName = this.getContext().currentListItem.getBindingContext().getProperty("Product_Text");
